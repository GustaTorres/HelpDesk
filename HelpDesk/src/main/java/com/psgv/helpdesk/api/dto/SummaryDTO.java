...
public class SummaryDTO implements Serializable{
	 ...
	 * 
	 */
	private static final long serialVersionUID = 4946600355012507668L;

	private Integer amountNew;
	private Integer amountResolved;
	private Integer amountApproved;
	private Integer amountDispproved;
	...
	public Integer getAmountDispproved() {
		return amountDispproved;
	}
	public void setAmountDispproved(Integer amountDispproved) {
		this.amountDispproved = amountDispproved;
	}
